...
class VehicleInformation(models.Model):
    ...
    def get_vehicle_information(self, registration_number):
        ...
        if r.status_code == requests.codes['ok']:
            ...
            return {"car_make":vehicle_information.car_make,"registration_number":vehicle_information.registration_number,"make":vehicle_information.make,"model":vehicle_information.model,
                    "color":vehicle_information.color,"CarMake":vehicle_information.car_make,"year":vehicle_information.year,"car_model":vehicle_information.car_model, 'vehicle_id': vehicle_information.id}
        else:
